// ===== MUSIC PLAYER =====
// API - rozhranie JS vsetky vlastnosti, funkcie atd.
...
// Song titles - musi byt totozny s nazvom songu v priecinku
const songs = [
    ...
    "04. Running",
    "05. Dreamers",
    "06. Dualistic Continua",
    "07. Come Together",
    "08. Let You Go",
    "09. Good To Me",
    "10. Phonetic Losing Control"];


// Keep track of song - Od akeho indexu zacne hrat prehravac 
let songIndex = 0;
...
function loadSong(song) {
    ...
    cover.src = `img/cover-album/${song}.jpg`;
}
